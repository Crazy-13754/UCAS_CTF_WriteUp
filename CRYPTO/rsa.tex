...
\tableofcontents
\section{说在前面}
虽然本文花费大力气写了数学种种理论，笔者却深感这并无必要，因为无论作者抑或读者所关心的其实是技术，数学理论不过是些模糊空气——固然是十分重要的支撑，写起来也不容忽视，但也不妨碍人们对其漠不关心。所以，读者大可以略看繁复的证明，注意力集中于各类技术的细节。
...
\begin{enumerate}
	\item \label{motion1} 传统对称体制下密钥的存储和分配问题；
	\item 消息鉴别问题,就是指用来检验消息来自于声称的来源并且没有被修改。
\end{enumerate}

其中，第 \ref{motion1} 条考虑的其实就是对称加密时的密钥传输问题。
