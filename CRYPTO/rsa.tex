...
% 考虑通解的情况。若已知解为 $x_1, y_1$, 且有 $x_2 = x_1 + k$ 也可以构成解，则有 $a x_2 + a k + b y = c$，即 $a x_2 + b(y + \frac{a}{b} k) = c$。上式中 $k, \frac{a}{b} k \in \mathbb{Z}$ 才有意义，又有：

% \[
%     \frac{a}{b} = \frac{\frac{a}{\gcd(a, b)}}{\frac{b}{\gcd(a, b)}} \quad\text{记为} \frac{a'}{b'}
%     \]

% 则应有 $k = k'b'$，即有通解 $x_k = x_1 + k \frac{b}{\gcd(a, b)}$，$y_k = x_k - k \frac{a}{\gcd(a, b)}$。
